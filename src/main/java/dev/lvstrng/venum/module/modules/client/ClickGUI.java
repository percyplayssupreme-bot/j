package dev.lvstrng.venum.module.modules.client;
...
import dev.lvstrng.venum.module.setting.ModeSetting;
...
public final class ClickGUI extends Module implements PacketReceiveListener {
	...
	public ClickGUI() {
		super(EncryptedString.of("Nightrix"),
	...
	public void onEnable() {
		...
		Venum.INSTANCE.previousScreen = mc.currentScreen;

		if (Venum.INSTANCE.clickGui != null) {
			mc.setScreenAndRender(Venum.INSTANCE.clickGui);
		} else if (mc.currentScreen instanceof InventoryScreen) {
			Venum.INSTANCE.guiInitialized = true;
		}
	...
	public void onDisable() {
		...
		if (mc.currentScreen instanceof ClickGui) {
			Venum.INSTANCE.clickGui.close();
			mc.setScreenAndRender(Venum.INSTANCE.previousScreen);
			Venum.INSTANCE.clickGui.onGuiClose();
		} else if (mc.currentScreen instanceof InventoryScreen) {
			Venum.INSTANCE.guiInitialized = false;
		}
	...
	public void onPacketReceive(PacketReceiveEvent event) {
		if (Venum.INSTANCE.guiInitialized) {
