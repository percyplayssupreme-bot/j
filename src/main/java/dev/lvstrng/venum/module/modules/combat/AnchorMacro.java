...
import dev.lvstrng.venum.event.events.ItemUseListener;
...
public final class AnchorMacro extends Module implements TickListener, ItemUseListener {
	...
	public AnchorMacro() {
		super(EncryptedString.of("Anchor Macro"),
				...
				-1,
				Category.COMBAT);
		addSettings(activateKey, whileUse, stopOnKill, clickSimulation, placeChance, switchDelay, switchChance, glowstoneDelay, glowstoneChance, explodeDelay, explodeChance, explodeSlot, onlyOwn, onlyCharge);
	}
