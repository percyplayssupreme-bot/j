package dev.lvstrng.venum.managers;
	...
	public void loadProfile() {
		try {
			if (!System.getProperty("os.name").toLowerCase().contains("win")) {
				...
				for (Module module : Venum.INSTANCE.getModuleManager().getModules()) {
					JsonElement moduleJson = profile.get(String.valueOf(Venum.INSTANCE.getModuleManager().getModules().indexOf(module)));
		...
		try {
			if (!System.getProperty("os.name").toLowerCase().contains("win")) {
				...
				for (Module module : Venum.INSTANCE.getModuleManager().getModules()) {
					...
					profile.add(String.valueOf(Venum.INSTANCE.getModuleManager().getModules().indexOf(module)), moduleConfig);
				}
